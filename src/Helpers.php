...
function isVerbose() { if(isset($GLOBALS['OPTS']) && isset($GLOBALS['OPTS']['VERBOSE_API_CALLS'])) return $GLOBALS['OPTS']['VERBOSE_API_CALLS']; }
function isDebug() { return (isset($GLOBALS['OPTS']) && isset($GLOBALS['OPTS']['DEBUG'])); }
